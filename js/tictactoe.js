// Note: For the TicTacToe game, I found that the instructor's typos and various misspellings of the word "ticTacToe" are essential to get the code to work.
// This is, of course, bad practice, but I've yet to figure out how to get the code working with correct spelling, so I have included it as written originally, spelling inconsistencies included.
// My apologies for the poor semantics.
